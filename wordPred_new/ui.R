...
shinyUI(fluidPage(titlePanel("Next Word Prediction Application: Data Science Capstone Project"),
  ...
  theme = "wordProphet.ui.css",
  navbarPage("wordProphet",id ="navpanel",
             tabPanel("Home",
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          hr(),
                          p(img(src = "http://files.softicons.com/download/social-media-icons/free-social-media-icons-by-uiconstock/png/512x512/Linkedin-Icon.png", height=30, width=40), strong(em(a("Connect at Linkedin",href="https://www.linkedin.com/in/panayiotis-leon/")))),
                          p(img(src = "https://assets-cdn.github.com/images/modules/logos_page/Octocat.png", height=40, width=50),strong(em(a("Github: Capstone Project",href="https://github.com/Ghost-8D/data_science_capstone"))))),
